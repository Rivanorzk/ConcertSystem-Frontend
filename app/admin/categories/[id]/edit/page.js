        ...
        return (
            <div className="min-h-screen p-5 lg:p-8">
                <div className="max-w-4xl mx-auto">
                    <div className="bg-white border border-[#E5D6D0] rounded-2xl p-8 text-center text-sm text-[#8C7777]">
                        Loading category...
                    </div>
                </div>
            </div>
            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="mt-6">
                    ...
                    <p className="mt-2 text-sm text-[#8C7777]">
                        Ubah informasi dan icon kategori.
                    </p>
                </div>
                ...
                >
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            rows={4}
                            className="mt-2 w-full border border-[#E5D6D0] rounded-xl px-4 py-3 text-sm text-[#1E1E1E] outline-none resize-none transition focus:border-[#7A1F2B] focus:ring-2 focus:ring-[#7A1F2B]/10"
                        />
                    </div>
                    ...
                    <div>
                        <div className="relative">
                            <Search className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-[#8C7777]" />
                            ...
                            <input
                                ...
                                className="w-full border border-[#E5D6D0] rounded-xl pl-11 pr-4 py-3 text-sm outline-none focus:border-[#7A1F2B] focus:ring-2 focus:ring-[#7A1F2B]/10"
                            />
                        </div>
                    </div>
